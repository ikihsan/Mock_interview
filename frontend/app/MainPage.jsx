            ...
            <footer className="bg-gray-800 text-white py-8">
                <div className="max-w-screen-xl mx-auto px-4">
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                        <div>
                            <h3 className="text-lg font-semibold mb-4">Mock Interview Platform</h3>
                            <p className="text-gray-400">Prepare for your dream job with AI-powered mock interviews.</p>
                        </div>
                        <div>
                            <h3 className="text-lg font-semibold mb-4">Quick Links</h3>
                            <ul className="space-y-2">
                                <li><a href="/dashboard" className="text-gray-400 hover:text-white">Dashboard</a></li>
                                <li><a href="/upgrade" className="text-gray-400 hover:text-white">Upgrade</a></li>
                                <li><a href="/work" className="text-gray-400 hover:text-white">How it Works</a></li>
                            </ul>
                        </div>
                        <div>
                            <h3 className="text-lg font-semibold mb-4">Contact</h3>
                            <p className="text-gray-400">Email: support@mockinterview.com</p>
                            <p className="text-gray-400">© 2025 Mock Interview Platform. All rights reserved.</p>
                        </div>
                    </div>
                </div>
            </footer>
